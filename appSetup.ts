...
var valid_moves: string[] = [];
var whiteTurn: boolean = true;
var currentPiece: string = "";
var currentPieceLocation: string = "";
...
function makeMove(piece, rowDest, colDest): void {
...
function contains(arr, obj): boolean {
...
function identifyPiece(piece): string {
  // identify innerHTML and return associated piece name 
  return pieces[piece];
}

function showMoves(valid_moves): void {
